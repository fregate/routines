...
d<def> avg                             [0.445611][min: 1][max: 17] boost_distr avg [0.375436] std_distr avg [0.389656]
d<minstd_rand0> avg                    [0.282912][min: 1][max: 17] boost_distr avg [0.300062] std_distr avg [0.277356]
d<minstd_rand> avg                     [0.263579][min: 1][max: 17] boost_distr avg [0.234541] std_distr avg [0.242932]
d<mt19937> avg                         [0.239374][min: 1][max: 17] boost_distr avg [0.250156] std_distr avg [0.213126]
d<mt19937_64> avg                      [0.318787][min: 1][max: 17] boost_distr avg [0.520094] std_distr avg [0.265458]
d<ranlux24_base> avg                   [0.266317][min: 1][max: 17] boost_distr avg [0.270372] std_distr avg [0.293896]
d<ranlux48_base> avg                   [0.308734][min: 1][max: 17] boost_distr avg [0.543258] std_distr avg [0.349362]
d<ranlux24> avg                        [0.509718][min: 1][max: 17] boost_distr avg [0.509500] std_distr avg [0.524407]
d<ranlux48> avg                        [1.316230][min: 1][max: 17] boost_distr avg [1.537980] std_distr avg [1.354680]
d<knuth_b> avg                         [0.346366][min: 1][max: 17] boost_distr avg [0.334183] std_distr avg [0.336718]
d<default_random_engine> avg           [0.223277][min: 1][max: 17] boost_distr avg [0.247973] std_distr avg [0.205557]
d<boost_minstd_rand> avg               [0.326535][min: 1][max: 17] boost_distr avg [0.307935] std_distr avg [0.309066]
d<boost_minstd_rand0> avg              [0.320584][min: 1][max: 17] boost_distr avg [0.315953] std_distr avg [0.300267]
d<boost_rand48> avg                    [0.289478][min: 1][max: 17] boost_distr avg [0.284353] std_distr avg [0.295985]
d<boost_ecuyer1988> avg                [0.357311][min: 1][max: 17] boost_distr avg [0.341912] std_distr avg [0.358191]
d<boost_hellekalek1995> avg            [0.739963][min: 1][max: 17] boost_distr avg [0.811600] std_distr avg [0.752588]
d<boost_kreutzer1986> avg              [0.262087][min: 1][max: 17] boost_distr avg [0.263873] std_distr avg [0.222261]
d<boost_taus88> avg                    [0.227826][min: 1][max: 17] boost_distr avg [0.194869] std_distr avg [0.223125]
d<boost_mt11213b> avg                  [0.205841][min: 1][max: 17] boost_distr avg [0.229622] std_distr avg [0.246898]
d<boost_mt19937> avg                   [0.205531][min: 1][max: 17] boost_distr avg [0.233702] std_distr avg [0.279876]
d<boost_lagged_fibonacci607> avg       [0.450287][min: 1][max: 17] boost_distr avg [0.540828] std_distr avg [0.252914]
d<boost_lagged_fibonacci44497> avg     [0.440417][min: 1][max: 17] boost_distr avg [0.415248] std_distr avg [0.222398]
d<boost_ranlux4> avg                   [0.488766][min: 1][max: 17] boost_distr avg [0.640954] std_distr avg [0.729310]
d<boost_ranlux3> avg                   [0.610844][min: 1][max: 17] boost_distr avg [0.466327] std_distr avg [0.298813]
iterations [59683016]
